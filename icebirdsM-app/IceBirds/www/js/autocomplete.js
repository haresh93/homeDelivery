...
angular.module('google.places', [])
    ...
    .directive('gPlacesAutocompleteDrawer', ['$window', '$document', function ($window, $document) {
        var TEMPLATE = [
            '<div class="pac-container" ng-if="isOpen()" ng-style="{top: position.top+\'px\', left: position.left+\'px\', width: position.width+\'px\'}" style="display: block;margin-left:3px;" role="listbox" aria-hidden="{{!isOpen()}}">',
        ...
        return {
            ...
            link: function ($scope, element) {
                ...
                $scope.$watch('predictions', function () {
                    ...
                    console.log($scope.position.top);
                    console.log($scope.position.left);
                });
